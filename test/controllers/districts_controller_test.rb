...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { localization_district: @district.localization_district, name_district: @district.name_district } }, as: :json
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { localization_district: @district.localization_district, name_district: @district.name_district } }, as: :json
    assert_response 200
  end
